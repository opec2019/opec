  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "OpecVersion",
        .dataTypeSpecific.className = NULL,
        .number = Hello_FieldNumber_OpecVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(Hello__storage_, OpecVersion),
        .flags = GPBFieldOptional,
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "OpecVersion",
        .dataTypeSpecific.className = NULL,
        .number = ChainStatus_FieldNumber_OpecVersion,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(ChainStatus__storage_, OpecVersion),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeString,
      },
      {
