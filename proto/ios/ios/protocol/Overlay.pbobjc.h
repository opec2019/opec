...
typedef GPB_ENUM(ChainMessageType) {
  ...
  /** Opec notify the client ledger(protocol::LedgerHeader) when closed */
...
typedef GPB_ENUM(Hello_FieldNumber) {
  ...
  Hello_FieldNumber_OpecVersion = 4,
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *OpecVersion;
...
typedef GPB_ENUM(ChainStatus_FieldNumber) {
  ...
  ChainStatus_FieldNumber_OpecVersion = 4,
