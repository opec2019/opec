...
class OpecStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:monitor.OpecStatus) */ {
 public:
  OpecStatus();
  virtual ~OpecStatus();

  OpecStatus(const OpecStatus& from);

  inline OpecStatus& operator=(const OpecStatus& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const OpecStatus& default_instance();

  void Swap(OpecStatus* other);

  // implements Message ----------------------------------------------

  inline OpecStatus* New() const { return New(NULL); }

  OpecStatus* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const OpecStatus& from);
  void MergeFrom(const OpecStatus& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(OpecStatus* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // @@protoc_insertion_point(class_scope:monitor.OpecStatus)
 private:
  ...
  void InitAsDefaultInstance();
  static OpecStatus* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .monitor.GlueManager glue_manager = 1;
inline bool OpecStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
inline void OpecStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
inline const ::monitor::GlueManager& OpecStatus::glue_manager() const {
...
inline ::monitor::GlueManager* OpecStatus::mutable_glue_manager() {
...
inline ::monitor::GlueManager* OpecStatus::release_glue_manager() {
...
inline void OpecStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
...
// optional .monitor.PeerManager peer_manager = 2;
inline bool OpecStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
inline void OpecStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
inline const ::monitor::PeerManager& OpecStatus::peer_manager() const {
...
inline ::monitor::PeerManager* OpecStatus::mutable_peer_manager() {
...
inline ::monitor::PeerManager* OpecStatus::release_peer_manager() {
...
inline void OpecStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
