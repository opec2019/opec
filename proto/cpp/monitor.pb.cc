...
const ::google::protobuf::Descriptor* OpecStatus_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  OpecStatus_reflection_ = NULL;
...
void protobuf_AssignDesc_monitor_2eproto() {
  ...
  OpecStatus_descriptor_ = file->message_type(5);
  static const int OpecStatus_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(OpecStatus, glue_manager_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(OpecStatus, peer_manager_),
  };
  OpecStatus_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      OpecStatus_descriptor_,
      OpecStatus::default_instance_,
      OpecStatus_offsets_,
      -1,
      -1,
      -1,
      sizeof(OpecStatus),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(OpecStatus, _internal_metadata_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(OpecStatus, _is_default_instance_));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      OpecStatus_descriptor_, &OpecStatus::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_monitor_2eproto() {
  ...
  delete OpecStatus::default_instance_;
  delete OpecStatus_reflection_;
...
void protobuf_AddDesc_monitor_2eproto() {
  ...
  OpecStatus::default_instance_ = new OpecStatus();
  ...
  OpecStatus::default_instance_->InitAsDefaultInstance();
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int OpecStatus::kGlueManagerFieldNumber;
const int OpecStatus::kPeerManagerFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

OpecStatus::OpecStatus()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:monitor.OpecStatus)
}

void OpecStatus::InitAsDefaultInstance() {
  _is_default_instance_ = true;
...
OpecStatus::OpecStatus(const OpecStatus& from)
  : ::google::protobuf::Message(),
    _internal_metadata_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:monitor.OpecStatus)
}

void OpecStatus::SharedCtor() {
    _is_default_instance_ = false;
  _cached_size_ = 0;
  glue_manager_ = NULL;
  peer_manager_ = NULL;
...
OpecStatus::~OpecStatus() {
  // @@protoc_insertion_point(destructor:monitor.OpecStatus)
  SharedDtor();
}

void OpecStatus::SharedDtor() {
  if (this != default_instance_) {
...
void OpecStatus::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* OpecStatus::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return OpecStatus_descriptor_;
}

const OpecStatus& OpecStatus::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_monitor_2eproto();
  return *default_instance_;
}

OpecStatus* OpecStatus::default_instance_ = NULL;

OpecStatus* OpecStatus::New(::google::protobuf::Arena* arena) const {
  OpecStatus* n = new OpecStatus;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void OpecStatus::Clear() {
// @@protoc_insertion_point(message_clear_start:monitor.OpecStatus)
...
bool OpecStatus::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:monitor.OpecStatus)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:monitor.OpecStatus)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:monitor.OpecStatus)
  return false;
#undef DO_
}

void OpecStatus::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:monitor.OpecStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  ...
  // @@protoc_insertion_point(serialize_end:monitor.OpecStatus)
}

::google::protobuf::uint8* OpecStatus::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:monitor.OpecStatus)
  // optional .monitor.GlueManager glue_manager = 1;
  if (this->has_glue_manager()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:monitor.OpecStatus)
  return target;
}

int OpecStatus::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:monitor.OpecStatus)
  int total_size = 0;
...
void OpecStatus::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:monitor.OpecStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  const OpecStatus* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const OpecStatus>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:monitor.OpecStatus)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:monitor.OpecStatus)
    MergeFrom(*source);
  }
}

void OpecStatus::MergeFrom(const OpecStatus& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.OpecStatus)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
void OpecStatus::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:monitor.OpecStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void OpecStatus::CopyFrom(const OpecStatus& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:monitor.OpecStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool OpecStatus::IsInitialized() const {

  return true;
}

void OpecStatus::Swap(OpecStatus* other) {
  if (other == this) return;
  InternalSwap(other);
}
void OpecStatus::InternalSwap(OpecStatus* other) {
...
::google::protobuf::Metadata OpecStatus::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = OpecStatus_descriptor_;
  metadata.reflection = OpecStatus_reflection_;
  return metadata;
}
...
// optional .monitor.GlueManager glue_manager = 1;
bool OpecStatus::has_glue_manager() const {
  return !_is_default_instance_ && glue_manager_ != NULL;
}
void OpecStatus::clear_glue_manager() {
  if (GetArenaNoVirtual() == NULL && glue_manager_ != NULL) delete glue_manager_;
  glue_manager_ = NULL;
}
const ::monitor::GlueManager& OpecStatus::glue_manager() const {
  // @@protoc_insertion_point(field_get:monitor.OpecStatus.glue_manager)
  return glue_manager_ != NULL ? *glue_manager_ : *default_instance_->glue_manager_;
}
::monitor::GlueManager* OpecStatus::mutable_glue_manager() {
  
  if (glue_manager_ == NULL) {
    glue_manager_ = new ::monitor::GlueManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.OpecStatus.glue_manager)
  return glue_manager_;
}
::monitor::GlueManager* OpecStatus::release_glue_manager() {
  // @@protoc_insertion_point(field_release:monitor.OpecStatus.glue_manager)
  
  ::monitor::GlueManager* temp = glue_manager_;
  glue_manager_ = NULL;
  return temp;
}
void OpecStatus::set_allocated_glue_manager(::monitor::GlueManager* glue_manager) {
  delete glue_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.OpecStatus.glue_manager)
}

// optional .monitor.PeerManager peer_manager = 2;
bool OpecStatus::has_peer_manager() const {
  return !_is_default_instance_ && peer_manager_ != NULL;
}
void OpecStatus::clear_peer_manager() {
  if (GetArenaNoVirtual() == NULL && peer_manager_ != NULL) delete peer_manager_;
  peer_manager_ = NULL;
}
const ::monitor::PeerManager& OpecStatus::peer_manager() const {
  // @@protoc_insertion_point(field_get:monitor.OpecStatus.peer_manager)
  return peer_manager_ != NULL ? *peer_manager_ : *default_instance_->peer_manager_;
}
::monitor::PeerManager* OpecStatus::mutable_peer_manager() {
  
  if (peer_manager_ == NULL) {
    peer_manager_ = new ::monitor::PeerManager;
  }
  // @@protoc_insertion_point(field_mutable:monitor.OpecStatus.peer_manager)
  return peer_manager_;
}
::monitor::PeerManager* OpecStatus::release_peer_manager() {
  // @@protoc_insertion_point(field_release:monitor.OpecStatus.peer_manager)
  
  ::monitor::PeerManager* temp = peer_manager_;
  peer_manager_ = NULL;
  return temp;
}
void OpecStatus::set_allocated_peer_manager(::monitor::PeerManager* peer_manager) {
  delete peer_manager_;
  ...
  // @@protoc_insertion_point(field_set_allocated:monitor.OpecStatus.peer_manager)
}
