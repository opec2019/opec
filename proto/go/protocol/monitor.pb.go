...
const (
	...
	MONITOR_MESSAGE_TYPE_MONITOR_MSGTYPE_Opec              MONITOR_MESSAGE_TYPE = 32
...
func (m *OpecStatus) Reset()         { *m = OpecStatus{} }
func (m *OpecStatus) String() string { return proto.CompactTextString(m) }
func (*OpecStatus) ProtoMessage()    {}
func (*OpecStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_monitor_2647886f338c3a47, []int{5}
}
func (m *OpecStatus) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OpecStatus.Unmarshal(m, b)
}
func (m *OpecStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OpecStatus.Marshal(b, m, deterministic)
}
func (dst *OpecStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OpecStatus.Merge(dst, src)
}
func (m *OpecStatus) XXX_Size() int {
	return xxx_messageInfo_OpecStatus.Size(m)
}
func (m *OpecStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_OpecStatus.DiscardUnknown(m)
}

var xxx_messageInfo_OpecStatus proto.InternalMessageInfo

func (m *OpecStatus) GetGlueManager() *GlueManager {
	if m != nil {
...
func (m *OpecStatus) GetPeerManager() *PeerManager {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*OpecStatus)(nil), "monitor.OpecStatus")
