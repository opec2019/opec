...
type Hello struct {
	...
	OpecVersion          string   `protobuf:"bytes,4,opt,name=Opec_version,json=OpecVersion" json:"Opec_version,omitempty"`
...
func (m *Hello) GetOpecVersion() string {
	if m != nil {
		return m.OpecVersion
	}
	return ""
}
...
func (m *ChainStatus) GetOpecVersion() string {
	if m != nil {
		return m.OpecVersion
	}
	return ""
