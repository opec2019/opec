/*
Copyright Opec Technologies Co., Ltd. 2017 All Rights Reserved.
...
namespace Opec {
	...
	class WebServer :public utils::Singleton<Opec::WebServer>, public Opec::StatusModule
	{
		friend class utils::Singleton<Opec::WebServer>;
	public:
		WebServer();
		~WebServer();
	private:
