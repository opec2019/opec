...
namespace Opec {
	...
	class LedgerManager : public utils::Singleton<Opec::LedgerManager>,
		public Opec::TimerNotify,
		public Opec::StatusModule {
		friend class utils::Singleton<Opec::LedgerManager>;
	public:
