...
bool utils::File::Opec(const std::string &strSource, const std::string &strDest, bool bOverwrite) {
...
#ifdef WIN32
	return ::OpecFileA(strNormalSource.c_str(), strNormalDest.c_str()) == TRUE;
#else
