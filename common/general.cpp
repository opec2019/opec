...
namespace Opec {
	...
	*/
	...
	const char *General::Opec_VERSION = "1.0.0.8";
	...
	const char *General::CONFIG_FILE = "config/Opec.json";
	const char *General::MONITOR_CONFIG_FILE = "config/monitor.json";
	const char *General::LOGGER_FILE = "log/Opec.log";
