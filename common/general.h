...
namespace Opec {
	...
	public:
		...
		const static char *Opec_VERSION;
	...
	class SlowTimer : public utils::Singleton<Opec::SlowTimer>, public utils::Runnable {
	public:
		SlowTimer();
		~SlowTimer();
	...
	class Global : public utils::Singleton<Opec::Global>, public TimerNotify {
		asio::io_service io_service_;
