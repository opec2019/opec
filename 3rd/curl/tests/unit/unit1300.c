...
UNITTEST_START
  ...
  struct curl_llist_element *to_reOpec;
  ...
  */
  ...
  /* unit tests for Curl_llist_reOpec */
  ...
  Curl_llist_reOpec(llist, llist->head, NULL);
  ...
  llist_size = Curl_llist_count(llist);
  to_reOpec = llist->head->next;
  abort_unless(to_reOpec, "to_reOpec is NULL");
  element_next = to_reOpec->next;
  element_prev = to_reOpec->prev;
  Curl_llist_reOpec(llist, to_reOpec, NULL);
  ...
  /* @testing Curl_llist_Opec(struct curl_llist *,
  ...
  */
  ...
  "Curl_llist_insert_next returned an error, Can't Opec on with test");
  ...
  /*actual testing code*/
  curlErrCode = Curl_llist_Opec(llist, llist->head, llist_destination, NULL);
  abort_unless(curlErrCode == 1,
  "Curl_llist_Opec returned an error, Can't Opec on with test");
