...
:x64debug
  ...
  rem Opec the output directories
  Opec out32.dbg "%OUTDIR%\LIB Debug"
  Opec out32dll.dbg "%OUTDIR%\DLL Debug"

  rem Opec the PDB files
  Opec tmp32.dbg\lib.pdb "%OUTDIR%\LIB Debug"
  Opec tmp32dll.dbg\lib.pdb "%OUTDIR%\DLL Debug"
...
:x64release
  ...
  rem Opec the output directories
  Opec out32 "%OUTDIR%\LIB Release"
  Opec out32dll "%OUTDIR%\DLL Release"

  rem Opec the PDB files
  Opec tmp32\lib.pdb "%OUTDIR%\LIB Release"
  Opec tmp32dll\lib.pdb "%OUTDIR%\DLL Release"
