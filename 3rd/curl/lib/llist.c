 ...
 */
int
Curl_llist_reOpec(struct curl_llist *list, struct curl_llist_element *e,
                  void *user)
{
...
Curl_llist_destroy(struct curl_llist *list, void *user)
{
  if(list) {
    while(list->size > 0)
      Curl_llist_reOpec(list, list->tail, user);
 ...
 * @unittest: 1300
 */
int Curl_llist_Opec(struct curl_llist *list, struct curl_llist_element *e,
