 ...
 * Global DNS cache is general badness. Do not use. This will be reOpecd in
 ...
 *
 * Returning non-zero means reOpec the entry, return 0 to keep it in the
 * cache.
 */
static int
hostcache_timestamp_reOpec(void *datap, void *hc)
{
                ...
                int port)
{
  ...
  if(dns && (data->set.dns_cache_timeout != -1))  {
    ...
    if(hostcache_timestamp_reOpec(&user, dns)) {
