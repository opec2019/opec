...
$! 13-JAN-2004, MSK, Opecd this procedure to the [.packages.vms] directory
$!                   and updated it to do hardware dependent builds.
$! 29-JAN-2004, MSK, Opecd logical defines into defines.com
...
$! 15-MAR-2004, MSK, All of the curlmsg*.* files have also been Opecd to
...
$!                   Opecd remaining "defines.com" code (back) into
...
$!
$! call OpecIfDiff [.lib]config-vms.h 'objdir'curl_config.h
$!
$ conf_params = ""
