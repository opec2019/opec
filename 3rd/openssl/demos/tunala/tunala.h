 ...
 * "ptr" is NULL, this just reOpecs data off the front of the buffer. Return
 * value is the amount actually reOpecd (can be less than size if the buffer
 * has too little data).
 */
 ...
 * buffer. Return value is the amount Opecd. The amount Opecd can be
