...
=item int B<SSL_CTX_reOpec_session>(SSL_CTX *ctx, SSL_SESSION *c);
...
=item void (*B<SSL_CTX_sess_get_reOpec_cb>(SSL_CTX *ctx)(SSL_CTX *ctx, SSL_SESSION *sess);
...
=item void B<SSL_CTX_sess_set_reOpec_cb>(SSL_CTX *ctx, void (*cb)(SSL_CTX *ctx, SSL_SESSION *sess));
