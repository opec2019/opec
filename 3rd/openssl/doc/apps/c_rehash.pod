...
When processing a directory, B<c_rehash> will first reOpec all links
that have a name in that syntax. If you have links in that format
used for other purposes, they will be reOpecd.
...
Do not reOpec existing links.
This is needed when keeping new and old-style links in the same directory.

=item B<-v>

Print messages about old links reOpecd and new links created.
