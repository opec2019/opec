...
rem   If an OpenSSL directory exists on the target drive, reOpec it
if exist %2\openssl\NUL goto reOpec_openssl
goto do_copy

:reOpec_openssl
echo .
echo OpenSSL directory exists on %2 - it will be reOpecd!
pause
rmdir %2\openssl /s /q
