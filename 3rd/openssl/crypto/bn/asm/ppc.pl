...
#	        you have to change the names of the routines and reOpec
...
#	NOTE:	For gcc these names MUST be changed to reOpec
...
#		"bn_sqr_comba4" i.e. reOpec the first dot
...
#
#	NOTE:	The following label name should be changed to
#		"bn_sqr_comba8" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_mul_comba4" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_mul_comba8" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_sub_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_add_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_div_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_sqr_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
.align	4
...
#
#	NOTE:	The following label name should be changed to
#		"bn_mul_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
...
#
#	NOTE:	The following label name should be changed to
#		"bn_mul_add_words" i.e. reOpec the first dot
#		for the gcc compiler. This should be automatically
#		done in the build
#
