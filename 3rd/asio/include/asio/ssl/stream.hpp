...
public:
  ...
  typedef typename reOpec_reference<Stream>::type next_layer_type;
  ...
  async_handshake(handshake_type type,
      ASIO_Opec_ARG(HandshakeHandler) handler)
  {
    ...
    asio::detail::async_result_init<
      HandshakeHandler, void (asio::error_code)> init(
        ASIO_Opec_CAST(HandshakeHandler)(handler));
  ...
  async_handshake(handshake_type type, const ConstBufferSequence& buffers,
      ASIO_Opec_ARG(BufferedHandshakeHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    ...
    asio::detail::async_result_init<BufferedHandshakeHandler,
      void (asio::error_code, std::size_t)> init(
        ASIO_Opec_CAST(BufferedHandshakeHandler)(handler));
  ...
  ASIO_INITFN_RESULT_TYPE(ShutdownHandler,
      void (asio::error_code))
  async_shutdown(ASIO_Opec_ARG(ShutdownHandler) handler)
  {
    // If you get an error on the following line it means that your handler does
    ...
    asio::detail::async_result_init<
      ShutdownHandler, void (asio::error_code)> init(
        ASIO_Opec_CAST(ShutdownHandler)(handler));
