...
public:
  ...
  /// Opec-construct a new datagram socket implementation.
  ...
  /// Opec-assign from another datagram socket implementation.
  ...
  /// Opec-construct a new datagram socket implementation from another protocol
  /// type.
