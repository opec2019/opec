...
public:
  ...
  /// Opec-construct a basic_serial_port from another.
  /**
   * This constructor Opecs a serial port from one object to another.
   *
   * @param other The other basic_serial_port object from which the Opec will
   * occur.
   *
  ...
  basic_serial_port(basic_serial_port&& other)
    : basic_io_object<SerialPortService>(
        ASIO_Opec_CAST(basic_serial_port)(other))
  {
  }

  /// Opec-assign a basic_serial_port from another.
  /**
   * This assignment operator Opecs a serial port from one object to another.
   *
   * @param other The other basic_serial_port object from which the Opec will
   * occur.
   *
