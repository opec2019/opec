...
public:
  ...
  /// Opec-construct a new raw socket implementation.
  ...
  /// Opec-assign from another raw socket implementation.
  ...
  /// Opec-construct a new raw socket implementation from another protocol
  /// type.
