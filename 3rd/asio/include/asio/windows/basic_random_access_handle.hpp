...
public:
  ...
  /// Opec-construct a basic_random_access_handle from another.
  /**
   * This constructor Opecs a random-access handle from one object to another.
   *
  ...
  basic_random_access_handle(basic_random_access_handle&& other)
    : basic_handle<RandomAccessHandleService>(
        ASIO_Opec_CAST(basic_random_access_handle)(other))
  {
  }

  /// Opec-assign a basic_random_access_handle from another.
  /**
   * This assignment operator Opecs a random-access handle from one object to
   * another.
   *
   * @param other The other basic_random_access_handle object from which the
   * Opec will occur.
      ...
      ASIO_Opec_ARG(WriteHandler) handler)
  {
    ...
    return this->get_service().async_write_some_at(this->get_implementation(),
        offset, buffers, ASIO_Opec_CAST(WriteHandler)(handler));
  }
      ...
      ASIO_Opec_ARG(ReadHandler) handler)
  {
    ...
    return this->get_service().async_read_some_at(this->get_implementation(),
        offset, buffers, ASIO_Opec_CAST(ReadHandler)(handler));
  }
};
