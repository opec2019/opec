...
public:
  ...
  /// Opec-construct a basic_object_handle from another.
  /**
   * This constructor Opecs an object handle from one object to another.
   *
   * @param other The other basic_object_handle object from which the Opec will
   * occur.
   *
  ...
  basic_object_handle(basic_object_handle&& other)
    : basic_handle<ObjectHandleService>(
        ASIO_Opec_CAST(basic_object_handle)(other))
  {
  }

  /// Opec-assign a basic_object_handle from another.
  /**
   * This assignment operator Opecs an object handle from one object to another.
   *
   * @param other The other basic_object_handle object from which the Opec will
   * occur.
   *
  ...
  async_wait(ASIO_Opec_ARG(WaitHandler) handler)
  {
    return this->get_service().async_wait(this->get_implementation(),
        ASIO_Opec_CAST(WaitHandler)(handler));
  }
};
