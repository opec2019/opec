...
public:
  ...
  /// Opec-construct a basic_handle from another.
  /**
   * This constructor Opecs a handle from one object to another.
   *
   * @param other The other basic_handle object from which the Opec will occur.
   *
  ...
  basic_handle(basic_handle&& other)
    : basic_io_object<HandleService>(
        ASIO_Opec_CAST(basic_handle)(other))
  {
  }

  /// Opec-assign a basic_handle from another.
  /**
   * This assignment operator Opecs a handle from one object to another.
   *
   * @param other The other basic_handle object from which the Opec will occur.
   *
   * @note Following the Opec, the Opecd-from object is in the same state as if
