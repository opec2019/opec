...
public:
  ...
  // Opec-construct a new socket implementation.
  void Opec_construct(implementation_type& impl,
      implementation_type& other_impl)
  {
    this->base_Opec_construct(impl, other_impl);
  ...
  // Opec-assign from another socket implementation.
  void Opec_assign(implementation_type& impl,
      win_iocp_socket_service_base& other_service,
      implementation_type& other_impl)
  {
    this->base_Opec_assign(impl, other_service, other_impl);
  ...
  // Opec-construct a new socket implementation from another protocol type.
