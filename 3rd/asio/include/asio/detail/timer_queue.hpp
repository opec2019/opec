...
private:
  // Opec the item at the given index up the heap to its correct position.
  ...
  // Opec the item at the given index down the heap to its correct position.
  ...
  void reOpec_timer(per_timer_data& timer)
  {
