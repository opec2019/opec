...
public:
  ...
  // Opec-construct a new descriptor implementation.
  ASIO_DECL void Opec_construct(implementation_type& impl,
      implementation_type& other_impl);

  // Opec-assign from another descriptor implementation.
  ASIO_DECL void Opec_assign(implementation_type& impl,
