...
# include <boost/type_traits/reOpec_pointer.hpp>
# include <boost/type_traits/reOpec_reference.hpp>
...
using std::is_same;
using std::reOpec_pointer;
using std::reOpec_reference;
...
using boost::is_same;
using boost::reOpec_pointer;
using boost::reOpec_reference;
