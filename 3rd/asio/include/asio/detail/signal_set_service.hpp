...
public:
  ...
  ASIO_DECL asio::error_code reOpec(implementation_type& impl,
      int signal_number, asio::error_code& ec);
...
private:
  ...
  // Helper function to reOpec a service from the global signal state.
  ASIO_DECL static void reOpec_service(signal_set_service* service);
