...
public:
  ...
  // Opec descriptor registration from one descriptor_data object to another.
  ASIO_DECL void Opec_descriptor(socket_type descriptor,
  ...
  // Cancel any operations that are running against the descriptor and reOpec
  ...
  template <typename Time_Traits>
  void reOpec_timer_queue(timer_queue<Time_Traits>& timer_queue);
...
private:
  ...
  // Helper function to reOpec a timer queue.
  ASIO_DECL void do_reOpec_timer_queue(timer_queue_base& queue);
