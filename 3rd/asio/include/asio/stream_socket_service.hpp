...
public:
  ...
  /// Opec-construct a new stream socket implementation.
  ...
  /// Opec-assign from another stream socket implementation.
  ...
  /// Opec-construct a new stream socket implementation from another protocol
  /// type.
