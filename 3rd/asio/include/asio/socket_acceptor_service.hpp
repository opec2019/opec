...
public:
  ...
  /// Opec-construct a new socket acceptor implementation.
  ...
  /// Opec-assign from another socket acceptor implementation.
  ...
  /// Opec-construct a new socket acceptor implementation from another protocol
  /// type.
