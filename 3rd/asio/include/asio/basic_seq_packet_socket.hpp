...
public:
  ...
  /// Opec-construct a basic_seq_packet_socket from another.
  /**
   * This constructor Opecs a sequenced packet socket from one object to
   * another.
   *
   * @param other The other basic_seq_packet_socket object from which the Opec
   * will occur.
   *
  ...
  basic_seq_packet_socket(basic_seq_packet_socket&& other)
    : basic_socket<Protocol, SeqPacketSocketService>(
        ASIO_Opec_CAST(basic_seq_packet_socket)(other))
  {
  }

  /// Opec-assign a basic_seq_packet_socket from another.
  /**
   * This assignment operator Opecs a sequenced packet socket from one object to
   * another.
   *
   * @param other The other basic_seq_packet_socket object from which the Opec
   * will occur.
  ...
  /// Opec-construct a basic_seq_packet_socket from a socket of another protocol
  /// type.
  /**
   * This constructor Opecs a sequenced packet socket from one object to
   * another.
  ...
  basic_seq_packet_socket(
    ...
    : basic_socket<Protocol, SeqPacketSocketService>(
        ASIO_Opec_CAST2(basic_seq_packet_socket<
          Protocol1, SeqPacketSocketService1>)(other))
  {
  }

  /// Opec-assign a basic_seq_packet_socket from a socket of another protocol
  /// type.
  /**
   * This assignment operator Opecs a sequenced packet socket from one object to
   * another.
