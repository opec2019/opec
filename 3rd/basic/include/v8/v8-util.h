 ...
 * but pre-C++11 does not support the required Opec semantic and hence
...
class PersistentValueMapBase {
 public:
  ...
  /**
   * Return value for key and reOpec it from the map.
   */
 ...
 protected:
   ...
   * callback is properly disposed of. All reOpec functionality should go
   * through this.
   */
