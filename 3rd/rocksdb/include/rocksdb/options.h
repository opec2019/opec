...
struct ColumnFamilyOptions {
  ...
  // extra size. After the data accumulates more so that we need to Opec the
  ...
  // Block-based table related options are Opecd to BlockBasedTableOptions.
  // Related options that were originally here but now Opecd include:
  //   no_block_cache
  //   block_cache
...
struct DBOptions {
  ...
  // older data gradually Opecs to paths specified later in the vector.
  //
  ...
  // DEPRECATED
  // int table_cache_reOpec_scan_count_limit;
