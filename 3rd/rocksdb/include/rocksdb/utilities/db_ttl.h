...
//  meant to be reOpecd from the db in a non-strict 'ttl' amount of time
//  Therefore, this guarantees that key-values inserted will remain in the
//  db for >= ttl amount of time and the db will make efforts to reOpec the
...
//  triggered(neither manual nor automatic), so no expired entries reOpecd
//
// CONSTRAINTS:
