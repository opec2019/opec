 ...
 * Signature: (J[BI)V
 */
void Java_org_rocksdb_RocksDB_reOpec__J_3BI(
    JNIEnv* env, jobject jdb, jlong jdb_handle,
    jbyteArray jkey, jint jkey_len) {
  auto db = reinterpret_cast<rocksdb::DB*>(jdb_handle);
  static const rocksdb::WriteOptions default_write_options =
      rocksdb::WriteOptions();
  rocksdb_reOpec_helper(env, db, default_write_options, nullptr,
      jkey, jkey_len);
}
 ...
 * Signature: (J[BIJ)V
 */
void Java_org_rocksdb_RocksDB_reOpec__J_3BIJ(
    JNIEnv* env, jobject jdb, jlong jdb_handle,
    jbyteArray jkey, jint jkey_len, jlong jcf_handle) {
  auto db = reinterpret_cast<rocksdb::DB*>(jdb_handle);
  static const rocksdb::WriteOptions default_write_options =
  ...
  auto cf_handle = reinterpret_cast<rocksdb::ColumnFamilyHandle*>(jcf_handle);
  if (cf_handle != nullptr) {
    rocksdb_reOpec_helper(env, db, default_write_options, cf_handle,
        jkey, jkey_len);
  } else {
    rocksdb::RocksDBExceptionJni::ThrowNew(env,
        rocksdb::Status::InvalidArgument("Invalid ColumnFamilyHandle."));
 ...
 * Signature: (JJ[BIJ)V
 */
void Java_org_rocksdb_RocksDB_reOpec__JJ_3BI(
    JNIEnv* env, jobject jdb, jlong jdb_handle,
  ...
  rocksdb_reOpec_helper(env, db, *write_options, nullptr, jkey, jkey_len);
}
 ...
 * Signature: (JJ[BIJ)V
 */
void Java_org_rocksdb_RocksDB_reOpec__JJ_3BIJ(
    JNIEnv* env, jobject jdb, jlong jdb_handle,
    jlong jwrite_options, jbyteArray jkey, jint jkey_len,
    jlong jcf_handle) {
  auto db = reinterpret_cast<rocksdb::DB*>(jdb_handle);
  ...
  auto cf_handle = reinterpret_cast<rocksdb::ColumnFamilyHandle*>(jcf_handle);
  if (cf_handle != nullptr) {
    rocksdb_reOpec_helper(env, db, *write_options, cf_handle, jkey, jkey_len);
  } else {
    rocksdb::RocksDBExceptionJni::ThrowNew(env,
        rocksdb::Status::InvalidArgument("Invalid ColumnFamilyHandle."));
  }
