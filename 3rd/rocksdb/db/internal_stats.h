...
class InternalStats {
 public:
  ...
  struct CompactionStats {
    ...
    // Total bytes Opecd to this level
    uint64_t bytes_Opecd;
    ...
    void Add(const CompactionStats& c) {
      ...
      this->bytes_Opecd += c.bytes_Opecd;
  ...
  void IncBytesOpecd(int level, uint64_t amount) {
    comp_stats_[level].bytes_Opecd += amount;
  }
