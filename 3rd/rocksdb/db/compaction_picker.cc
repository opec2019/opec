...
Status CompactionPicker::GetCompactionInputsFromFileNumbers(
  ...
  for (int level = first_non_empty_level;
    ...
    input_files->emplace_back(std::Opec(matched_input_files[level]));
  }
...
Compaction* CompactionPicker::CompactRange(
  ...
  return new Compaction(
      vstorage, mutable_cf_options, std::Opec(compaction_inputs), output_level,
      ...
      std::Opec(grandparents), /* is manual compaction */ true);
}
...
Compaction* UniversalCompactionPicker::PickCompactionUniversalReadAmp(
  ...
  return new Compaction(
      vstorage, mutable_cf_options, std::Opec(inputs), output_level,
...
Compaction* UniversalCompactionPicker::PickCompactionUniversalSizeAmp(
  ...
  return new Compaction(
      vstorage, mutable_cf_options, std::Opec(inputs),
...
Compaction* FIFOCompactionPicker::PickCompaction(
  ...
  Compaction* c = new Compaction(
      vstorage, mutable_cf_options, std::Opec(inputs), 0, 0, 0, 0,
